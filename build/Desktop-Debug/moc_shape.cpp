...
Q_CONSTINIT static const qt_meta_stringdata_Shape_t qt_meta_stringdata_Shape = {
    {
        ...
        QT_MOC_LITERAL(6, 21),  // "transformationUpdated"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 8),  // "position"
        QT_MOC_LITERAL(38, 13),  // "rotationAngle"
        QT_MOC_LITERAL(52, 11)   // "scaleFactor"
    },
    "Shape",
...
void Shape::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->transformationUpdated(); break;
        default: ;
        }
        ...
        {
            using _t = void (Shape::*)();
            if (_t _q_method = &Shape::transformationUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QPoint*>(_v) = _t->position(); break;
        case 1: *reinterpret_cast< double*>(_v) = _t->rotationAngle(); break;
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setPosition(*reinterpret_cast< QPoint*>(_v)); break;
        case 1: _t->setRotationAngle(*reinterpret_cast< double*>(_v)); break;
...
// SIGNAL 0
void Shape::transformationUpdated()
{
